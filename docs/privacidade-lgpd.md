...
SEFAZ MT: Primeiro Emplacamento segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_mt_primeiro_emplacamento@mcp.ai](mailto:sefaz_mt_primeiro_emplacamento@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
